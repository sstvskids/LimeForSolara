...
if not (debug.getupvalue or debug.getconstants) then
	...
	return loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/LimeForRoblox/refs/heads/main/BridgeDuel.lua"))()
end
...
if not shared.badexecs == true and (game.PlaceId == 11630038968 or game.PlaceId == 12011959048 or game.PlaceId == 14191889582 or game.PlaceId == 14662411059) then
	...
	return loadstring(game:HttpGet("https://raw.githubusercontent.com/sstvskids/LimeForRoblox/refs/heads/main/Universal.lua"))()
end
